...
impl<T: Trait> Module<T> {
	...
	fn transfer_from(from: T::AccountId, to: T::AccountId, kitty_id: T::KittyIndex) -> DispatchResult {
		Self::owned_kitties((from.clone(), Some(kitty_id))).ok_or(Error::<T>::RequireOwner)?;
